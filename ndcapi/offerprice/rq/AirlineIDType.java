...
@XmlSeeAlso({
    offerprice.rq.BookingReferenceType.AirlineID.class,
    offerprice.rq.SecurePaymentPaxInfoType.Carriers.Carrier.class,
    offerprice.rq.CarrierFeeInfoType.CarrierFees.Fee.AirlineID.class,
    offerprice.rq.AirlineID.class
})
