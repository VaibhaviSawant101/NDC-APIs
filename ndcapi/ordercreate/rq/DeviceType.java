...
@XmlSeeAlso({
    ordercreate.rq.SecurePaymentAlertType.Details.CustomerDevice.class,
    ordercreate.rq.PinPhraseAnswerType.Device.class,
    ordercreate.rq.PinPhraseQuestionType.Device.class
})
