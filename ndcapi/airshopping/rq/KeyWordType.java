...
@XmlSeeAlso({
    ndcapi.airshopping.rq.AirShopReqAffinityQueryType.KeywordPreferences.KeywordPreference.class,
    ndcapi.airshopping.rq.StateProvQueryType.Keywords.KeyWord.class,
    ndcapi.airshopping.rq.KeyWord.class
})
