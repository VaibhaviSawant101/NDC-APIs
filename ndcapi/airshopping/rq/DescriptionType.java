...
@XmlSeeAlso({
    ndcapi.airshopping.rq.MarketingMessages.MarketMessage.class,
    ndcapi.airshopping.rq.MarketingInfoType.Message.class,
    ndcapi.airshopping.rq.ServiceDescriptionType.Description.class,
    ndcapi.airshopping.rq.Description.class
})
