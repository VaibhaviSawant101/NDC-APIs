...
public class AddlBaggageInfoType {
     ...
     * This is why there is not a {@code set} method for the allowableBag property.
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the bagCharge property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     * @return
     *     The value of the bagCharge property.
     */
    public List<AddlBaggageInfoType.BagCharge> getBagCharge() {
        if (bagCharge == null) {
            bagCharge = new ArrayList<>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the carryOnAllowableBag property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the carryOnChargeableBag property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the checkedChargeableBag property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
