...
public class TaxCouponInfoType {
    ...
    public static class TicketDocument {
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a {@code set} method for the couponNumber property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         ...
         * 
         * @return
         *     The value of the couponNumber property.
         */
        ...
        public static class CouponNumber {
             ...
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the Jakarta XML Binding object.
             * This is why there is not a {@code set} method for the unticketedPointInfo property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
             ...
             * 
             * @return
             *     The value of the unticketedPointInfo property.
             */
