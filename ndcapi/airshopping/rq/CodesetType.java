...
@XmlSeeAlso({
    ndcapi.airshopping.rq.PointOfSaleType.TouchPoint.Device.class,
    ndcapi.airshopping.rq.SeatLocationType.Characteristics.Characteristic.class,
    ndcapi.airshopping.rq.AlliancePreferencesType.Alliance.class,
    ndcapi.airshopping.rq.FlightPreferencesType.Aircraft.Seats.Position.class,
    ndcapi.airshopping.rq.DeviceType.Type.class,
    CabinType.class
})
