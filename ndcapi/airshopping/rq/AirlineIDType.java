...
@XmlSeeAlso({
    ndcapi.airshopping.rq.BookingReferenceType.AirlineID.class,
    ndcapi.airshopping.rq.SecurePaymentPaxInfoType.Carriers.Carrier.class,
    ndcapi.airshopping.rq.CarrierFeeInfoType.CarrierFees.Fee.AirlineID.class,
    ndcapi.airshopping.rq.AirlineID.class
})
