...
@XmlSeeAlso({
    ndcapi.airshopping.rq.AirShopReqParamsType.ServiceFilters.class,
    ndcapi.airshopping.rq.AirShopReqParamsType.Pricing.FeeExemption.class,
    ndcapi.airshopping.rq.AirShopReqAffinityQueryType.OriginDestination.class,
    ndcapi.airshopping.rq.AirShopReqAttributeQueryType.OriginDestination.class
})
