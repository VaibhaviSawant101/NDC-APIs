...
public class CouponTicketDocType {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the penaltyReferences property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     * @return
     *     The value of the penaltyReferences property.
     */
    public List<Object> getPenaltyReferences() {
        if (penaltyReferences == null) {
            penaltyReferences = new ArrayList<>();
        }
