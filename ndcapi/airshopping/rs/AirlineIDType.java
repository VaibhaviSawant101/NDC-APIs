...
@XmlSeeAlso({
    airshopping.rs.BookingReferenceType.AirlineID.class,
    airshopping.rs.SecurePaymentPaxInfoType.Carriers.Carrier.class,
    airshopping.rs.CarrierFeeInfoType.CarrierFees.Fee.AirlineID.class,
    airshopping.rs.AirlineID.class
})
