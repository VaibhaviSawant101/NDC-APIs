...
@XmlSeeAlso({
    airshopping.rs.MarketingMessages.MarketMessage.class,
    airshopping.rs.MarketingInfoType.Message.class,
    airshopping.rs.ServiceDescriptionType.Description.class,
    airshopping.rs.Description.class
})
