...
@XmlSeeAlso({
    orderview.rs.BookingReferenceType.AirlineID.class,
    orderview.rs.SecurePaymentPaxInfoType.Carriers.Carrier.class,
    orderview.rs.CarrierFeeInfoType.CarrierFees.Fee.AirlineID.class,
    orderview.rs.AirlineID.class
})
