...
@XmlSeeAlso({
    servicelist.rs.PointOfSaleType.TouchPoint.Device.class,
    servicelist.rs.SeatLocationType.Characteristics.Characteristic.class,
    servicelist.rs.AlliancePreferencesType.Alliance.class,
    servicelist.rs.FlightPreferencesType.Aircraft.Seats.Position.class,
    servicelist.rs.DeviceType.Type.class,
    CabinType.class
})
