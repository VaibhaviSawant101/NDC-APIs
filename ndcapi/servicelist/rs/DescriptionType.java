...
@XmlSeeAlso({
    servicelist.rs.MarketingMessages.MarketMessage.class,
    servicelist.rs.MarketingInfoType.Message.class,
    servicelist.rs.ServiceDescriptionType.Description.class,
    servicelist.rs.Description.class
})
