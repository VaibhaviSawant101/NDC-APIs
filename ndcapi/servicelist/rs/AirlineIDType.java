...
@XmlSeeAlso({
    servicelist.rs.BookingReferenceType.AirlineID.class,
    servicelist.rs.SecurePaymentPaxInfoType.Carriers.Carrier.class,
    servicelist.rs.CarrierFeeInfoType.CarrierFees.Fee.AirlineID.class,
    servicelist.rs.AirlineID.class
})
