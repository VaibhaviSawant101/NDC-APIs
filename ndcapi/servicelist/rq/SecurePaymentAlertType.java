    ...
    extends TrxProcessObjectBaseType
{
    ...
    public static class Details {
        ...
        public static class TxnDatas {
             ...
             * This is why there is not a {@code set} method for the txnDate property.
             * 
             * <p>
             ...
             * 
             * @return
             *     The value of the txnDate property.
             */
            public List<String> getTxnDate() {
                if (txnDate == null) {
                    txnDate = new ArrayList<>();
                }
                return this.txnDate;
            }
    ...
    public static class ProcessingInfos {
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a {@code set} method for the processingInfo property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
