...
@XmlSeeAlso({
    servicelist.rq.SecurePaymentAlertType.Details.CustomerDevice.class,
    servicelist.rq.PinPhraseAnswerType.Device.class,
    servicelist.rq.PinPhraseQuestionType.Device.class
})
