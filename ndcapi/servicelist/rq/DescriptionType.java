...
@XmlSeeAlso({
    servicelist.rq.MarketingMessages.MarketMessage.class,
    servicelist.rq.MarketingInfoType.Message.class,
    servicelist.rq.ServiceDescriptionType.Description.class,
    servicelist.rq.Description.class
})
