...
@XmlSeeAlso({
    servicelist.rq.BookingReferenceType.AirlineID.class,
    servicelist.rq.SecurePaymentPaxInfoType.Carriers.Carrier.class,
    servicelist.rq.CarrierFeeInfoType.CarrierFees.Fee.AirlineID.class,
    servicelist.rq.AirlineID.class
})
