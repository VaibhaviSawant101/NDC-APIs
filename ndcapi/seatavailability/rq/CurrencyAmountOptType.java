...
@XmlSeeAlso({
    ...
    seatavailability.rq.TaxExemptionType.Total.class,
    seatavailability.rq.BaseFareTransactionType.Amount.class,
    seatavailability.rq.EquivFareTransactionType.Amount.class,
    seatavailability.rq.TotalFareTransactionType.Amount.class,
    seatavailability.rq.GroupBudgetType.Amount.class,
    seatavailability.rq.PersonBudgetType.Amount.class,
    seatavailability.rq.TaxDetailType.Total.class,
    seatavailability.rq.FeeSurchargeType.Total.class
})
