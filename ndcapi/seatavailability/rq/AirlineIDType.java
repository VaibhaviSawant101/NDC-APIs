...
@XmlSeeAlso({
    seatavailability.rq.BookingReferenceType.AirlineID.class,
    seatavailability.rq.SecurePaymentPaxInfoType.Carriers.Carrier.class,
    seatavailability.rq.CarrierFeeInfoType.CarrierFees.Fee.AirlineID.class,
    seatavailability.rq.AirlineID.class
})
