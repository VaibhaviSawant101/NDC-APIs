...
@XmlSeeAlso({
    seatavailability.rq.SecurePaymentAlertType.Details.CustomerDevice.class,
    seatavailability.rq.PinPhraseAnswerType.Device.class,
    seatavailability.rq.PinPhraseQuestionType.Device.class
})
