...
@XmlSeeAlso({
    seatavailability.rq.PointOfSaleType.TouchPoint.Device.class,
    seatavailability.rq.SeatLocationType.Characteristics.Characteristic.class,
    seatavailability.rq.AlliancePreferencesType.Alliance.class,
    seatavailability.rq.FlightPreferencesType.Aircraft.Seats.Position.class,
    seatavailability.rq.DeviceType.Type.class,
    CabinType.class
})
